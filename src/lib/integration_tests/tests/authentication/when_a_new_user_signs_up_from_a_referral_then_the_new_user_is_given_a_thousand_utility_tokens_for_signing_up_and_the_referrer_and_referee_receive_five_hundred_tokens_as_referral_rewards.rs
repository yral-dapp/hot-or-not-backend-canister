...
use shared_utils::{
    canister_specific::individual_user_template::types::{profile::{UserCanisterDetails, UserProfileDetailsForFrontend}, session::SessionType}, common::types::{
...
fn when_a_new_user_signs_up_from_a_referral_then_the_new_user_is_given_a_thousand_utility_tokens_for_signing_up_and_the_referrer_and_referee_receive_five_hundred_tokens_as_referral_rewards(
    ...
    state_machine.update_call(
        ...
        candid::encode_one(UserCanisterDetails {profile_owner: alice_principal_id, user_canister_id: alice_canister_id}).unwrap())
        .unwrap();
