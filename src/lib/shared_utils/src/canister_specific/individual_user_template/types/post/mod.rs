...
pub struct Post {
    ...
    #[serde(deserialize_with = "score_deserializer")]
    pub homefeed_ranking_score: FeedScore,
...
pub fn score_deserializer<'de, D>(deserializer: D) -> Result<FeedScore, D::Error>
where
    D: serde::Deserializer<'de>,
{
    let previous = u64::deserialize(deserializer)?;
    Ok(FeedScore {
...
impl Post {
    ...
    pub fn get_post_details_for_frontend_for_this_post(
        ...
        PostDetailsForFrontend {
            ...
            home_feed_ranking_score: self.homefeed_ranking_score.current_score,
            hot_or_not_feed_ranking_score: self
                .hot_or_not_details
                .as_ref()
                .map(|details| details.score.current_score),
    ...
    pub fn new(
        ...
        let mut post = Post {
            ...
            homefeed_ranking_score: FeedScore::default(),
    ...
    pub fn recalculate_home_feed_score(&mut self, current_time: &SystemTime) {
        ...
        self.homefeed_ranking_score = FeedScore {
    ...
    pub fn recalculate_hot_or_not_feed_score(&mut self, current_time: &SystemTime) {
        if self.hot_or_not_details.is_some() {
            ...
            self.hot_or_not_details.as_mut().unwrap().score = FeedScore {
                current_score: likes_component
                    + threshold_views_component
                    + average_percent_viewed_component
                    + post_share_component
...
mod test {
    ...
    fn when_new_post_created_then_their_home_feed_score_and_hot_or_not_feed_score_is_calculated() {
        ...
        assert!(post.homefeed_ranking_score.current_score > 0);
        assert!(post.hot_or_not_details.unwrap().score.current_score > 0);
    }
    ...
    fn test_recalculate_home_feed_score_case_1() {
        ...
        println!(
            "🧪 Homefeed score: {}",
            post.homefeed_ranking_score.current_score
        );
        assert_eq!(post.homefeed_ranking_score.current_score, 8_790);
    }
    ...
    fn test_recalculate_home_feed_score_case_2() {
        ...
        assert_eq!(post.homefeed_ranking_score.current_score, 4_120);
    }
    ...
    fn test_recalculate_home_feed_score_case_3() {
        ...
        assert_eq!(post.homefeed_ranking_score.current_score, 3_824);
    }
    ...
    fn test_recalculate_home_feed_score_case_4() {
        ...
        assert_eq!(post.homefeed_ranking_score.current_score, 3_710);
    }
    ...
    fn test_recalculate_home_feed_score_case_5() {
        ...
        assert_eq!(post.homefeed_ranking_score.current_score, 2_839);
    }
    ...
    fn test_recalculate_home_feed_score_case_6() {
        ...
        assert_eq!(post.homefeed_ranking_score.current_score, 4_226);
    }
    ...
    fn test_recalculate_home_feed_score_case_7() {
        ...
        assert_eq!(post.homefeed_ranking_score.current_score, 1_698);
    }
    ...
    fn test_recalculate_home_feed_score_case_8() {
        ...
        assert_eq!(post.homefeed_ranking_score.current_score, 1_198);
    }
    ...
    fn test_recalculate_home_feed_score_case_9() {
        ...
        assert_eq!(post.homefeed_ranking_score.current_score, 1_820);
    }
    ...
    fn test_recalculate_home_feed_score_case_10() {
        ...
        assert_eq!(post.homefeed_ranking_score.current_score, 1_520);
    }
