...
impl PlatformOrchestratorKnownPrincipal {
    pub fn add_global_known_principal(
        &mut self,
    ...
    pub fn add_subnet_orchestrator_known_principal(
        &mut self,
    ...
    pub fn get_subnet_known_principal(
        &self,
    ...
    pub fn get_global_known_principal(
        &self,
        known_principal_type: &KnownPrincipalType,
    ) -> Principal {
        *self
...
mod test {
    ...
    fn test_add_subnet_orchestrator_known_principal() {
        ...
        platform_known_principal.add_subnet_orchestrator_known_principal(
            subnet_principal,
            KnownPrincipalType::CanisterIdPostCache,
            post_cache_principal,
        );
        let retrieved_post_cache_principal = platform_known_principal
            .subnet_orchestrator_known_principals_map
        ...
        let retrieved_governance_canister = platform_known_principal
            .subnet_orchestrator_known_principals_map
            .get(&subnet_principal)
            .unwrap()
