...
const SUCCESS_HISTORY_MEMORY_V1: MemoryId = MemoryId::new(9);
...
pub fn get_success_history_v1_memory() -> Memory {
    MEMORY_MANAGER.with(|m| m.borrow_mut().get(SUCCESS_HISTORY_MEMORY_V1))
}
